defmodule GymLiveWeb.UserAuthTest do
  use GymLiveWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias GymLive.Account
  alias GymLiveWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, GymLiveWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      GymLiveWeb.Endpoint.subscribe(live_socket_id)
